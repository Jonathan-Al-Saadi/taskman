# taskman
A tiny Neovim plugin for extracting Markdown task lists (- [ ] and - [x]) from a directory and displaying them in a vims native selection tool (vim.ui.select) with jump navigation.
